...
function setActive(element, view) {
      if (view === 'desktop') {
    ...
    // code untuk toggle visibility pada halaman register dan login, dengan parameter inputId untuk id input password dan iconId untuk id ikon mata pada halaman tersebut
